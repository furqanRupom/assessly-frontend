...
const AdminManagement = () => {
  ...
  const admins = (data?.data as unknown as IUser[]) || [];
  ...
  const handleConfirmDelete = () => {
    console.log("Deleted Admin:", selectedAdmin);
        ...
        actions={(Admin) => (
          <div className="flex gap-2">
            <Button size="sm" variant="outline" asChild>
              <a href={`/dashboard/edit-Admin/${Admin.email}`}>
            ...
            <Button
              size="sm"
              variant="destructive"
              onClick={() => handleDeleteClick(Admin as IUser)}
            >
